...
def clipped_zoom(img, zoom_factor, **kwargs):
    ...
    # For multichannel images we don't want to apply the zoom factor to the RGB dimension, so instead we create a tuple
    # of zoom factors, one per array dimension, with 1's for any trailing dimensions after the width and height.
